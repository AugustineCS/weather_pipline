...
1st terminal run "airflow scheduler"  Start Scheduler                                             
                                                                                                                     
2nd terminal run "airflow webserver --port 8080"  Start Webserver                                                             
                                                                                                                
Open in Browser "http://localhost:8080" and see airflow running                                                                          
